...
class KedahEssentials extends StatelessWidget {
  final HomeController homeController;

  KedahEssentials({required this.homeController});
  ...
  final Map<String, String> translations = {
    ...
    'How are you?': 'Apa khabaq?',
    'Nice to meet you!': 'Seronok jumpa hang!',
    'Please': 'Tolong',
    ...
    'Do you speak ___?': 'Hang cakap ___?',
