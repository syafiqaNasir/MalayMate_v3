...
class PahangEssentials extends StatelessWidget {
  final HomeController homeController;

  PahangEssentials({required this.homeController});
  ...
  final Map<String, String> translations = {
    ...
    'Nice to meet you!': 'Seronok jumpe dengan awak!',
    'Please': 'Tolong',
    ...
    'How much does it cost?': 'Berapa hargenye?',
